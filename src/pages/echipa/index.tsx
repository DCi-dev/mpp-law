        ...
        <section className="lg:relative">
          <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center lg:py-48 lg:text-left">
            <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
              <h1 className="text-4xl font-bold tracking-tight text-primary-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              ...
              <p className="mx-auto mt-3 max-w-md text-lg text-primary-500 sm:text-xl md:mt-5 md:max-w-3xl">
