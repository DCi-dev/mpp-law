      ...
      <section className="flex h-full min-h-screen items-center justify-center overflow-hidden bg-hero-image bg-cover bg-center">
        <div className="max-w-7xl px-8 pt-24">
          <div className="mx-auto text-center">
            ...
            <h1 className="mb-4 max-w-4xl text-9xl font-bold uppercase leading-none tracking-tight text-gold">
              Mpp
            </h1>
            ...
            <Link href="/contact">
              <button
                className="focus:ring-primary-300 mr-3 mb-8 inline-flex transform items-center justify-center 
							rounded-lg bg-gold px-5 py-3 text-center text-base font-bold uppercase 
							text-black transition duration-300 ease-in-out hover:scale-105 hover:bg-white focus:ring-4"
              >
                Cere o consultație
